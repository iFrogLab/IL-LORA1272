...
def decrypt(key, filename,savefilename):
    chunksize = 64 * 1024
    outputFile = savefilename  #filename[11:]
...
def Main():
        ...
        print("Done.")
        filename = "(encrypted)readme.txt"
        decrypt(getKey(password), filename,"readme2.txt")
